...
TRAVERSE_ALL_FOLDERS = False: 为真时，遍历所有文件夹并解压缩。但是不在子文件夹里找密码。

TRAVERSE_ALL_FOLDERS = False: If it is True, it will traverse all folders and decompress. But it will not search passwords in sub folders.
